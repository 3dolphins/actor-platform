                    ...
                    if (loginHolder.getTop() != 0) {
                        ...
                        if (alpha > 0) {
                            welcomeImage.animate()
                                    .alpha(alpha).y(welcomeImageY).setDuration(50).start();
                            welcomeText.animate()
                                    .alpha(alpha).y(welcomeTextY).setDuration(50).start();
                        } else {
                            welcomeImage.animate().alpha(0).setDuration(50).start();
                            welcomeText.animate().alpha(0).setDuration(50).start();
                        }
                    }
