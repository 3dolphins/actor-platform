    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                imageView.setImageResource(R.drawable.intro_connected);
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                titleView.setText(R.string.tour_chatcall_title);
                bodyView.setText(R.string.tour_chatcall_text);
                imageView.setImageResource(R.drawable.intro_chatcall);
                break;
            case 5:
                titleView.setText(R.string.tour_payment_title);
                bodyView.setText(R.string.tour_payment_text);
                imageView.setImageResource(R.drawable.intro_payment);
                break;
            case 6:
                titleView.setText(R.string.tour_news_title);
                bodyView.setText(R.string.tour_news_text);
                imageView.setImageResource(R.drawable.intro_news);
                break;
        }
